...
# The base class for objects that interact with the Internet Archive
# "Printdisabled Unencrypted Ebook API", either to be initialized through
# de-serialized data received from the API or to be serialized into data to be
# sent to the API.
#
