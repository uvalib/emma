...
class ExternalFormatType      < EnumType; end
class FormatType              < EnumType; end
class PeriodicalFormatType    < EnumType; end
class Gender                  < EnumType; end
class LexileCode              < EnumType; end
class MessagePriority         < EnumType; end
class MessageType             < EnumType; end
class MetricType              < EnumType; end
class MusicScoreType          < EnumType; end
...
class MessageSortOrder        < EnumType; end
