# app/models/concerns/file_format/rtf.rb
#
...
module FileFormat::Rtf
  ...
  # @type [Boolean]
  #
  UPLOAD_PARSE = RTF_FORMAT.dig(:upload, :parse) || false
  ...
  # parser
  #
  # @return [FileParser::Rtf]
  #
  def parser
    @parser ||= FileParser::Rtf.new(file_handle)
  end
