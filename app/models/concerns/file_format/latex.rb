# app/models/concerns/file_format/latex.rb
#
...
module FileFormat::Latex
  ...
  #
  LATEX_FORMAT = FileFormat.configuration(FILE_TYPE)
  ...
  #
  FILE_EXTENSIONS = LATEX_FORMAT[:exts]
  ...
  #
  FORMAT_FIELDS = LATEX_FORMAT[:fields]
  ...
  # @type [Boolean]
  #
  UPLOAD_PARSE = LATEX_FORMAT.dig(:upload, :parse) || false
  ...
  #
  def parser
    @parser ||= FileParser::Latex.new(file_handle)
  end
