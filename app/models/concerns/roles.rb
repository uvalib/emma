...
module Roles
  ...
  #
  # [2.6] [Act] on [...] behalf [of members] to do things like download titles.
  # [2.6] [Have] some limited administrative abilities in their organizations,
  ...
  #
  # [2.7] [Manage] the collection, either by adding or removing *titles*, or by
  ...
  # [2.7] [Restricted] to the titles that are associated with their site.
  #
  # [2.8] [Manage] the periodical *series* and *editions*.
  # [2.8] [Restricted] to the periodicals that are associated with their site.
  #
  # === Membership Assistant
  # [1.8] [Administrative] users who have the right to manage user accounts,
  #       either updating aspects such as subscriptions or proof of disability,
  #       creating new users, or looking up information about users.
  ...
  #
  # [2.5] [Will] access to see and modify the information about [...] users;
  #       these are the endpoints that start with "/v2/accounts".
  # [2.5] [Allowed] to see and manage only those user accounts that are
  #       associated with their site.
  #
  # [2.9] [Able] to view and update the user accounts for those individual
  ...
  # [2.5] [Will] access to see and modify the information about [...] users;
  #       these are the endpoints that start with "/v2/accounts".
  # [2.5] [Allowed] access to users across all sites.
  #
  # [2.7] Perform as a "Collection Assistant" for all *titles* (not just ones
  #       associated with a specific site).
  #
  # [2.8] Perform as a "Collection Assistant" for all *periodicals* (not just
  #       ones associated with a specific site).
  #
  # [2.9] Perform as a "Membership Assistant" for all individuals.
  #
  # === Volunteer
  ...
  # Bookshare roles as documented in API section 2.9.2 (Create a user account).
  #
  ...
  BOOKSHARE_ROLES = {
    ...
    trustedVolunteer:    '???',
    collectionAssistant: 'API sections 1.8, 2.7, 2.8',
    membershipAssistant: 'API sections 1.8, 2.5, 2.9',
  }.freeze
