# app/models/action/batch_un_index.rb
#
...
# Remove entries from the Unified Index.
#
# @see file:config/locales/state_table.en.yml *en.emma.state_table.action.batch_un_index*
#
# @!method started?
# @!method deindexing?
# @!method completed?
...
# @!method aborted!
#
class Action::BatchUnIndex < Action::BulkOperation
  ...
  def deindex!(items, **opt)
    ...
    opt[:meth] ||= __method__
    prev_state = transition_to(:deindexing, **opt) or return false
