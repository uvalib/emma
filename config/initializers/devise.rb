...
Devise.setup do |config|
  ...
  # #secret_key_base as its #secret_key by default. You can change it below and
  # use your own secret key.
  # config.secret_key = '0bd704e09a537985ffc9f2f6f9cd5f89f5e892edd8e88116abe0076141161941c6b221703b068f1c62dba466d2fa3ca7fb65622da55ef7124d66a343d84f7d29'
  ...
  # (bson_ext recommended) by default. Other ORMs may be available as
  # additional gems.
  ...
  # will be down-cased upon creating or modifying a user and when used to
  ...
  # token fixation attacks. This means that, when using AJAX requests for sign
  # in and sign up, you need to get a new CSRF token from the server. You can
  # disable this option at your own risk.
  # config.clean_up_csrf_token_on_authentication = true

  # When false, Devise will not attempt to reload routes on eager load. This
  # can reduce the time taken to boot the app but if your application requires
  # the Devise mappings to be loaded during boot time the application won't
  # boot properly.
  ...
  # config.pepper = '2d61251d37cd6debfc81b7a1e5de9edf2c628fc0a7721b64d3ea7711e657fe2683fec0c69152a257984c629f156adff9c0eabc39e3fb9ffeab17a4c1eaa07608'
  ...
  # :failed_attempts = Locks account after a number of failed sign-in attempts.
  ...
  # Don't put a too small interval or your users won't have the time to change
  # their passwords.
  ...
  config.omniauth :bookshare, BOOKSHARE_API_KEY, '' if BS_AUTH
